...
- **Phase 5 security hardening** (`SECURITY_FEATURES_PLAN.md`): the gaps a stateless single-message filter structurally cannot see, each shipped default-off or behind a new subpath so the zero-config Tier-0 path is unchanged.
